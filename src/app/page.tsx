                        ...
                        <SignedIn>
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="font-medium text-sm hidden sm:block pr-1 text-white">Hello!</span>
                ...
                >
                    <div className="relative glass-card rounded-[3rem] p-4 border border-white/10 shadow-2xl">
                        ...
                        <div className="absolute -bottom-10 -right-10 glass-card p-6 rounded-3xl animate-bounce-slow hidden md:block">
                            ...
                            <p className="text-sm text-gray-400">Your vibe matched with <br /> the perfect flavor profile.</p>
                        </div>
                    </div>
                </motion.div>
            </section>
